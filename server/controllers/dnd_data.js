...
// See: https://goenning.net/2016/04/14/stop-reading-json-files-with-require/
// (don't worry about the title of the article)
// Node.js caches files after `require()`ing them for the first time, so it's
// safe to `require()` them repeatedly in the methods below
